...
/// Main navigation container. Tabs for Library, Create, and Search are currently
    ...
    _screens = [
      MultiBlocProvider(
        providers: [
          ...
          BlocProvider(create: (context) => getIt<BackupStatusBloc>()),
        ],
        child: const DeviceGalleryScreen(),
      ),
      BlocProvider(
        create: (context) => getIt<CloudBloc>(),
        child: const CloudPhotosScreen(),
      ),
